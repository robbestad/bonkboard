...
import { SOL_DECIMALS } from "@/utils/consts";
...
export function lamportsToPrettyUsd(lamports: BN, solPrice: number): string {
  return prettifyDecimal(
    tokenAtomicsToDecimal(lamports, SOL_DECIMALS) * solPrice,
    2
  );
}
